...
function addRenameHistory(str) {
  Settings.setSettingForKey(RENAME_HISTORY, createArr(str, sanitizeArray(getSettings(RENAME_HISTORY))));
}

function addFindHistory(str) {
  Settings.setSettingForKey(FIND_HISTORY, createArr(str, sanitizeArray(getSettings(FIND_HISTORY))));
}

function addReplaceHistory(str) {
  Settings.setSettingForKey(REPLACE_HISTORY, createArr(str, sanitizeArray(getSettings(REPLACE_HISTORY))));
}
