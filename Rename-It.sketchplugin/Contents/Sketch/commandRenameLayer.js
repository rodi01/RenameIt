...
*/
      proto.on = function on(evt, listener) {
        ...
        this.emit('newListener', evt, listenerIsWrapped
          ? listener.listener
          : listener)
...
*/
      proto.prependListener = function prependListener(evt, listener) {
        ...
        listeners.unshift(listenerIsWrapped
          ? listener
          : {
            listener: listener,
            once: false
...
*/
  ...
  \***********************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var upperCase = __webpack_require__(/*! upper-case */
      "./node_modules/upper-case/upper-case.js")
      var noCase = __webpack_require__(/*! no-case */
 ...
 */
  ...
  \*************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      exports.no = exports.noCase = __webpack_require__(/*! no-case */
      "./node_modules/no-case/no-case.js")
      exports.dot = exports.dotCase = __webpack_require__(/*! dot-case */
      "./node_modules/dot-case/dot-case.js")
      exports.swap = exports.swapCase = __webpack_require__(/*! swap-case */
      "./node_modules/swap-case/swap-case.js")
      exports.path = exports.pathCase = __webpack_require__(/*! path-case */
      "./node_modules/path-case/path-case.js")
      exports.upper = exports.upperCase = __webpack_require__(/*! upper-case */
      "./node_modules/upper-case/upper-case.js")
      exports.lower = exports.lowerCase = __webpack_require__(/*! lower-case */
      "./node_modules/lower-case/lower-case.js")
      exports.camel = exports.camelCase = __webpack_require__(/*! camel-case */
      "./node_modules/camel-case/camel-case.js")
      exports.snake = exports.snakeCase = __webpack_require__(/*! snake-case */
      "./node_modules/snake-case/snake-case.js")
      exports.title = exports.titleCase = __webpack_require__(/*! title-case */
      "./node_modules/title-case/title-case.js")
      exports.param = exports.paramCase = __webpack_require__(/*! param-case */
      "./node_modules/param-case/param-case.js")
      exports.header = exports.headerCase = __webpack_require__(/*! header-case */
      "./node_modules/header-case/header-case.js")
      exports.pascal = exports.pascalCase = __webpack_require__(/*! pascal-case */
      "./node_modules/pascal-case/pascal-case.js")
      exports.constant = exports.constantCase = __webpack_require__(/*! constant-case */
      "./node_modules/constant-case/constant-case.js")
      exports.sentence = exports.sentenceCase = __webpack_require__(/*! sentence-case */
      "./node_modules/sentence-case/sentence-case.js")
      exports.isUpper = exports.isUpperCase = __webpack_require__(/*! is-upper-case */
      "./node_modules/is-upper-case/is-upper-case.js")
      exports.isLower = exports.isLowerCase = __webpack_require__(/*! is-lower-case */
      "./node_modules/is-lower-case/is-lower-case.js")
      exports.ucFirst = exports.upperCaseFirst = __webpack_require__(/*! upper-case-first */
      "./node_modules/upper-case-first/upper-case-first.js")
      exports.lcFirst = exports.lowerCaseFirst = __webpack_require__(/*! lower-case-first */
  ...
  \*****************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _runtime = __webpack_require__(/*! ./runtime.js */
      "./node_modules/cocoascript-class/lib/runtime.js");

      exports.SuperCall = _runtime.SuperCall;

      // super when returnType is id and args are void id objc_msgSendSuper(struct
      // objc_super *super, SEL op, void)
      ...
      function ObjCClass(defn) {
        ...
        const className = (defn.className || defn.classname || "ObjCClass") + NSUUID
          .UUID()
          .UUIDString();
        ...
        cls
          .addInstanceMethodWithSelector_function_(NSSelectorFromString('init'), function () {
  ...
  \*******************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      // You can store this to call your function. this must be bound to the current
      // instance.
      function SuperCall(selector, argTypes, returnType) {
        const func = CFunc("objc_msgSendSuper", [
          {
        ...
        return function (...args) {
          ...
          const structPtr = MOPointer
            .alloc()
            .initWithValue_(struct);
      ...
      // Due to particularities of the JS bridge, we can't call into MOBridgeSupport
      // objects directly But, we can ask key value coding to do the dirty work for us
      // ;)
      function setKeys(o, d) {
        ...
        Object
          .keys(d)
          .map(k => funcDict.setValue_forKeyPath(d[k], "o." + k));
      }
      ...
      function CFunc(name, args, retVal) {
        function makeArgument(a) {
          if (!a) 
            return null;
          const arg = MOBridgeSupportArgument
            .alloc()
            .init();
          setKeys(arg, {type64: a.type});
          return arg;
        }
        const func = MOBridgeSupportFunction
          .alloc()
          .init();
        setKeys(func, {
          name: name,
...
*/
      ...
      function addStructToBridgeSupport(key, structDef) {
        // OK, so this is probably the nastiest hack in this file. We go modify
        // MOBridgeSupportController behind its back and use kvc to add our own
        // definition There isn't another API for this though. So the only other way
        // would be to make a real bridgesupport file.
        const symbols = MOBridgeSupportController
          .sharedController()
          .valueForKey('symbols');
        if (!symbols) 
          throw Error("Something has changed within bridge support so we can't add our definitions");
        
        // If someone already added this definition, don't re-register it.
        if (symbols[key] !== null) 
          return;
        const def = MOBridgeSupportStruct
          .alloc()
          .init();
        setKeys(def, {
          name: key,
      ...
      const object_getInstanceVariable = exports.object_getInstanceVariable = CFunc("object_getInstanceVariable", [
        {
          type: "@"
        }, {
          type: '*'
      ...
      const object_setInstanceVariable = exports.object_setInstanceVariable = CFunc("object_setInstanceVariable", [
        {
          type: "@"
        }, {
          type: '*'
      ...
      // We need Mocha to understand what an objc_super is so we can use it as a
      // function argument
  ...
  \*****************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var upperCase = __webpack_require__(/*! upper-case */
      "./node_modules/upper-case/upper-case.js")
      var snakeCase = __webpack_require__(/*! snake-case */
      "./node_modules/snake-case/snake-case.js")
 ...
 */
  ...
  \*****************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var lowerCase = __webpack_require__(/*! lower-case */
      "./node_modules/lower-case/lower-case.js")
 ...
 */
  ...
  \*****************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var NON_WORD_REGEXP = __webpack_require__(/*! ./vendor/non-word-regexp */
      "./node_modules/no-case/vendor/non-word-regexp.js")
      var CAMEL_CASE_REGEXP = __webpack_require__(/*! ./vendor/camel-case-regexp */
      "./node_modules/no-case/vendor/camel-case-regexp.js")
      var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(/*! ./vendor/camel-case-upper-regexp */
 ...
 */
  ...
  \*************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var camelCase = __webpack_require__(/*! camel-case */
      "./node_modules/camel-case/camel-case.js")
      var upperCaseFirst = __webpack_require__(/*! upper-case-first */
      "./node_modules/upper-case-first/upper-case-first.js")
 ...
 */
    ...
    (function (module, exports) {
      ...
      module.exports = {
        getUserPreferences: function (pluginName, defaultPrefs) {
          var prefs = {}
          var store = NSUserDefaults
            .alloc()
            .initWithSuiteName(SUITE_PREFIX + pluginName)
          Object
            .keys(defaultPrefs)
            .forEach(function (k) {
              if (typeof defaultPrefs[k] === 'boolean') {
                prefs[k] = isPresent(store.boolForKey(k))
                  ? Boolean(store.boolForKey(k))
                  : defaultPrefs[k]
              } else if (typeof defaultPrefs[k] === 'number') {
                prefs[k] = isPresent(store.doubleForKey(k))
                  ? store.doubleForKey(k)
                  : defaultPrefs[k]
              } else if (typeof defaultPrefs[k] === 'string') {
                prefs[k] = isPresent(store.stringForKey(k))
                  ? '' + store.stringForKey(k)
                  : defaultPrefs[k]
  ...
  \****************************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var ObjCClass = __webpack_require__(/*! cocoascript-class */
      "./node_modules/cocoascript-class/lib/index.js").default

      var COLOR_CLASSES = ['NSColor', 'NSDynamicSystemColor', 'NSCachedColorSpaceColor']function parseHexColor(color) {
        // Check the string for incorrect formatting.
        if (!color || color[0] !== '#') {
          if (color && color.class && COLOR_CLASSES.indexOf(String(color.class ())) !== -1) {
            return color
          }
      ...
      module.exports = function (browserWindow, panel, webview) {
        ...
        browserWindow.setBounds = function (bounds, animate) {
          ...
          // size.SetToMax(GetMinimumSize()); gfx::Size max_size = GetMaximumSize(); if
          // (!max_size.IsEmpty())   size.SetToMin(max_size);
          ...
          var screen = NSScreen
            .screens()
            .firstObject()
          cocoaBounds.origin.y = NSHeight(screen.frame()) - size.height - bounds.origin.y
        ...
        browserWindow.setFullScreenable = function (fullscreenable) {
          browserWindow._setCollectionBehavior(fullscreenable, NSWindowCollectionBehaviorFullScreenPrimary)
        ...
        browserWindow._setStyleMask = function (on, flag) {
          ...
          // Change style mask will make the zoom button revert to default, probably a bug
          // of Cocoa or macOS.
        ...
        if (!WindowDelegateClass) {
          WindowDelegateClass = ObjCClass({
            classname: 'WindowDelegateClass', utils: null,
  ...
  \*************************************************************************/
    ...
    (function (module, exports) {
      ...
      var tagsToFocus = '["text", "textarea", "date", "datetime-local", "email", "number", "month", "pass' +
          'word", "search", "tel", "time", "url", "week" ]'
      ...
      module.exports = function (webView, event) {
        ...
        var y = webView
          .frame()
          .size
          .height - point.y // the coord start from the bottom instead of the top
        return ('var el = document.elementFromPoint(' + // get the DOM element that match the event
            x + ', ' + y + '); if (el && ' + // some tags need to be focused instead of clicked
            tagsToFocus + '.indexOf(el.type) >= 0 && el.focus) {el.focus();' + // so focus them
            '} else {el.dispatchEvent(new Event("click", {bubbles: true}))' + // click the others
            '}')
      }
...
(https://github.com/electron/electron/blob/master/docs/api/browser-window.md) */
      var EventEmitter = __webpack_require__(/*! @skpm/events */
      "./node_modules/@skpm/events/index.js")
      var buildBrowserAPI = __webpack_require__(/*! ./browser-api */
      "./node_modules/sketch-module-web-view/lib/browser-api.js")
      var buildWebAPI = __webpack_require__(/*! ./webview-api */
      "./node_modules/sketch-module-web-view/lib/webview-api.js")
      var fitSubviewToView = __webpack_require__(/*! ./fitSubview */
      "./node_modules/sketch-module-web-view/lib/fitSubview.js")
      var dispatchFirstClick = __webpack_require__(/*! ./dispatch-first-click */
      "./node_modules/sketch-module-web-view/lib/dispatch-first-click.js")

      function BrowserWindow(options) {
        options = options || {}

        var identifier = options.identifier || NSUUID
          .UUID()
          .UUIDString()
        var threadDictionary = NSThread
          .mainThread()
          .threadDictionary()
        ...
        var mainScreenRect = NSScreen
          .screens()
          .firstObject()
          .frame()
        var cocoaBounds = NSMakeRect(typeof options.x !== 'undefined'
          ? options.x
          : Math.round((NSWidth(mainScreenRect) - width) / 2), typeof options.y !== 'undefined'
          ? options.y
          : Math.round((NSHeight(mainScreenRect) - height) / 2), width, height)
        ...
        // this is commented out because the toolbar doesn't appear otherwise
        // :thinking-face: if (!useStandardWindow || options.frame === false) {
        ...
        var panel = NSPanel
          .alloc()
          .initWithContentRect_styleMask_backing_defer(cocoaBounds, styleMask, NSBackingStoreBuffered, true)

        var webView = WebView
          .alloc()
          .initWithFrame(NSMakeRect(0, 0, options.width || 800, options.height || 600))
        ...
        if (options.transparent || options.frame === false) {
          ...
          var toolbar2 = NSToolbar
            .alloc()
            .initWithIdentifier('titlebarStylingToolbar')
        ...
        const title = options.title || (typeof __command !== 'undefined' && __command.pluginBundle()
        ...
        if (options.frame !== false) {
          ...
          // fill the window, and add subviews to that. http://crbug.com/380412
        ...
        // Set maximizable state last to ensure zoom button does not get reset by calls
        // to other APIs.
  ...
  \****************************************************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var EventEmitter = __webpack_require__(/*! @skpm/events */
      "./node_modules/@skpm/events/index.js")
      var parseWebArguments = __webpack_require__(/*! ./parseWebArguments */
      "./node_modules/sketch-module-web-view/lib/parseWebArguments.js")
      ...
      module.exports = function buildAPI(browserWindow, panel, webview) {
        ...
        if (!FrameLoadDelegateClass) {
          FrameLoadDelegateClass = ObjCClass({
            ...
            state: NSMutableDictionary.dictionaryWithDictionary({lastQueryId: null, wasReady: 0}),
            utils: null,

            // // Called when a client redirect is cancelled.
            // 'webView:didCancelClientRedirectForFrame:': function (   webView,   webFrame
            // ) {}, Called when the scroll position within a frame changes.
            'webView:didChangeLocationWithinPageForFrame:': function (webView) {
              this
                .utils
                .emitEvent('did-navigate-in-page', [
                  {},
                  webView
                    .windowScriptObject()
            ...
            // 'webView:didClearWindowObject:forFrame:': function (   webView,
            // windowObject,   webFrame ) {}, // Called when content starts arriving for a
            // page load. 'webView:didCommitLoadforFrame:': function (webView, webFrame) {},
            // // Notifies the delegate that a new JavaScript context has been created. N.B
            // - we intentionally omit the 2nd parameter (javascriptContext) It was causing
            // crashes in Sketch - possibly because of issues with converting it from
            ...
            'webView:didCreateJavaScriptContext:forFrame:': function (webView) {
              ...
              webView
                .windowScriptObject()
                .setValue_forKey_(this, CONSTANTS.JS_BRIDGE)
            },

            // the normal way to expose a selector to webscript is with
            // 'isSelectorExcludedFromWebScript:' but that didn't work, so this is an
            // alternative. This method gets invoked any time an unknown method is called on
            // this class by webscript
            'invokeUndefinedMethodFromWebScript:withArguments:': function (method, webArguments) {
              ...
              var args = this
                .utils
                .parseWebArguments(webArguments)
              if (!args) {
                return false
              }
            ...
            'webView:didFinishLoadForFrame:': function () {
              if (this.state.wasReady == 0) {
                ...
                this
                  .utils
                  .emitBrowserEvent('ready-to-show')
                this
                  .state
                  .setObject_forKey(1, 'wasReady')
              }
              this
                .utils
            ...
            'webView:didReceiveTitle:forFrame:': function (_, _title) {
              ...
              this
                .utils
                .emitBrowserEvent('page-title-updated', {
                  get defaultPrevented() {
            ...
            // Called when a frame will be closed. 'webView:willCloseFrame:': function
            // (webView, webFrame) {} Called when a frame receives a client redirect and
            // before it is fired.
            'webView:willPerformClientRedirectToURL:delay:fireDate:forFrame:': function (_, url) {
              this
                .utils
                .emit('will-navigate', {}, String(url.absoluteString))
            }
          })
        }
        ...
        frameLoadDelegate.utils = NSDictionary.dictionaryWithDictionary({
          setTitle: browserWindow
            .setTitle
            .bind(browserWindow),
          emitBrowserEvent: browserWindow
            .emit
            .bind(browserWindow),
          emit: webContents
            .emit
 ...
 */
      ...
      var laxWords = __webpack_require__(/*! ./articles */
          "./node_modules/titlecase/articles.js")
          .concat(__webpack_require__(/*! ./prepositions */
        "./node_modules/titlecase/prepositions.js"))
          .concat(__webpack_require__(/*! ./conjunctions */
          "./node_modules/titlecase/conjunctions.js"))
 ...
 */
  ...
  \********************************/
    ...
    (function (module, exports) {
      ...
      module.exports = "file://" + context
        .plugin
        .urlForResourceNamed("_webpack_resources/1ef26e2daf2f5fa178e2ffafb7faa73f.html")
        .path();
  ...
  \***********************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _utils = __webpack_require__(/*! ./lib/utils */
      "./src/lib/utils.js");

      var _TheUI = _interopRequireDefault(__webpack_require__(/*! ./lib/TheUI */
      "./src/lib/TheUI.js"));
 ...
 */
      ...
      function _default(context) {
        var data = (0, _utils.parseData)(context); // Return if there is no selection and show message

        if (data.selectionCount <= 0) {
          context
            .document
            .showMessage("Rename it: You need to select at least one layer or artboard");
          return;
        }
 ...
 */
      ...
      var mockHistory = {
        renameHistory: [
          "Hello", "World", "Item %N", "icon %wX%h", "Boo Hoo"
        ],
        findHistory: [],
        replaceHistory: []
      };
 ...
 */
  ...
  \****************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _sketchModuleUserPreferences = _interopRequireDefault(__webpack_require__(/*! sketch-module-user-preferences */
      "./node_modules/sketch-module-user-preferences/index.js"));
 ...
 */
      ...
      var preferences = _sketchModuleUserPreferences
        .default
        .getUserPreferences(pluginId, defaultPreferences);
      ...
      function addRenameHistory(str) {
        ...
        _sketchModuleUserPreferences
          .default
          .setUserPreferences(pluginId, {renameHistory: arr});
      }

      function addFindHistory(str) {
        _sketchModuleUserPreferences
          .default
          .setUserPreferences(pluginId, {
  ...
  \***************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _changeCase = _interopRequireDefault(__webpack_require__(/*! change-case */
      "./node_modules/change-case/change-case.js"));

      var _titlecase = _interopRequireDefault(__webpack_require__(/*! titlecase */
      "./node_modules/titlecase/to-title-case.js"));
 ...
 */
      ...
      function rename(options) {
        ...
        // newLayerName = newLayerName.replace(/\\\*/g, "*"); Add Width and/or height
  ...
  \**************************/
    ...
    (function (module, exports, __webpack_require__) {
      ...
      var _sketchModuleWebView = _interopRequireDefault(__webpack_require__(/*! sketch-module-web-view */
      "./node_modules/sketch-module-web-view/lib/index.js"));

      var _Rename = _interopRequireDefault(__webpack_require__(/*! ./Rename */
      "./src/lib/Rename.js"));

      var _FindReplace = __webpack_require__(/*! ./FindReplace */
      "./src/lib/FindReplace.js");
 ...
 */
      ...
      function showUpdatedMessage(count, data) {
        var layerStr = count === 1
          ? "Layer"
          : "Layers";
        data
          .doc
          .showMessage("".concat(_Constants.exclamations[Math.floor(Math.random() * _Constants.exclamations.length)], " ").concat(count, " ").concat(layerStr, " renamed."));
      }
      ...
      function theUI(context, data, options) {
        ...
        browserWindow.loadURL(__webpack_require__(/*! ../../resources/webview.html */
        "./resources/webview.html"));
        ...
        contents.on("onClickFindReplace", function (o) {
          var inputData = JSON.parse(o);
          var selData = inputData.searchScope === "page"
            ? data.allLayers
            : data.selection;
          var totalRenamed = 0;
 ...
 */
      ...
      function layerObject(layer, idx) {
        var parentName = layer.parentGroup() == null
          ? ""
          : layer
            .parentGroup()
            .name();
 ...
 */
      ...
      function parseData(context) {
        var onlyArtboards = arguments.length > 1 && arguments[1] !== undefined
          ? arguments[1]
          : false;
        ...
        var data = {
          ...
          pageName: "".concat(context.document.currentPage().name()),
...
//# sourceMappingURL=commandRenameLayer.js.map
