...
exports['default'] = function (context) {
  var data = (0, _utils.parseData)(context);
...
var _TheUI = __webpack_require__(2);
...
function parseData(context) {
  ...
  selection.forEach(function (layer, i) {
    data.selection[i] = {
      ...
      parentName: "" + String(layer.parentGroup().name())
    };
  });
...
var _Rename = __webpack_require__(3);

var _Rename2 = _interopRequireDefault(_Rename);

var _FindReplace = __webpack_require__(4);
      ...
      onClickFindReplace: function () {
        function onClickFindReplace(o) {
          ...
          data.selection.forEach(function (item) {
            ...
            var layer = data.selection[opts.currIdx].layer;
            layer.name = (0, _FindReplace2["default"])(opts);
          });
          webUI.close();
          showUpdatedMessage(data);
        }
...
function showUpdatedMessage(data) {
  var layerStr = data.selectionCount > 1 || data.selectionCount == 0 ? "Layers" : "Layer";
  data.doc.showMessage(String(_Constants.exclamations[Math.floor(Math.random() * _Constants.exclamations.length)]) + " " + String(data.selectionCount) + " " + layerStr + " renamed.");
}
...
var _changeCase = __webpack_require__(24);
...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/e2ed901db118b505adc5583b72b63128.html").path();
...
var NON_WORD_REGEXP = __webpack_require__(25)
var CAMEL_CASE_REGEXP = __webpack_require__(26)
var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(27)
...
exports.no = exports.noCase = __webpack_require__(18)
exports.dot = exports.dotCase = __webpack_require__(28)
exports.swap = exports.swapCase = __webpack_require__(29)
exports.path = exports.pathCase = __webpack_require__(30)
exports.upper = exports.upperCase = __webpack_require__(19)
exports.lower = exports.lowerCase = __webpack_require__(20)
exports.camel = exports.camelCase = __webpack_require__(22)
exports.snake = exports.snakeCase = __webpack_require__(23)
exports.title = exports.titleCase = __webpack_require__(31)
exports.param = exports.paramCase = __webpack_require__(32)
exports.header = exports.headerCase = __webpack_require__(33)
exports.pascal = exports.pascalCase = __webpack_require__(34)
exports.constant = exports.constantCase = __webpack_require__(35)
exports.sentence = exports.sentenceCase = __webpack_require__(36)
exports.isUpper = exports.isUpperCase = __webpack_require__(37)
exports.isLower = exports.isLowerCase = __webpack_require__(38)
exports.ucFirst = exports.upperCaseFirst = __webpack_require__(21)
exports.lcFirst = exports.lowerCaseFirst = __webpack_require__(39)
