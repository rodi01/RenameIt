...
var _Rename = __webpack_require__(14);

var _Rename2 = _interopRequireDefault(_Rename);

var _FindReplace = __webpack_require__(31);

var _FindReplace2 = _interopRequireDefault(_FindReplace);

var _sketchModuleWebView = __webpack_require__(32);
    ...
    handlers: {
      ...
      onClickRename: function () {
        function onClickRename(o) {
          ...
          (0, _History.addRenameHistory)(d.str);
        }
      ...
      onClickFindReplace: function () {
        function onClickFindReplace(o) {
          ...
          webUI.close();
          showUpdatedMessage(data);
          (0, _History.addFindHistory)(d.findText);
          (0, _History.addReplaceHistory)(d.replaceText);
        }
...
var _changeCase = __webpack_require__(15);
...
var MochaJSDelegate = __webpack_require__(33)
var parseQuery = __webpack_require__(34)
...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/de68488057ff61f9ad98ec69e6e5bc10.html").path();
