...
var Rename = function () {
  function Rename() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        _ref$allowTextStyle = _ref.allowTextStyle,
        allowTextStyle = _ref$allowTextStyle === undefined ? true : _ref$allowTextStyle;
  ...
  _createClass(Rename, [{
    ...
    value: function currentLayer(newLayerName, layerName) {
      ...
      if (this.allowTextCases) {
        ...
        // Title Case
        name = name.replace(this.shortcut(titleCase), (0, _titlecase2.default)(layerName));
        // UpperCase First
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/8227c4ca665c425cae9d8e92de8f55f4.html";
...
/* harmony import */ var _lib_VersionAlert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/VersionAlert */ "./src/lib/VersionAlert.js");
/*
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  // Check compatibility
  if (!Object(_lib_VersionAlert__WEBPACK_IMPORTED_MODULE_1__["isCompatible"])()) {
    Object(_lib_VersionAlert__WEBPACK_IMPORTED_MODULE_1__["showAlert"])();
    return;
  }
  ...
  Object(_lib_TheUI__WEBPACK_IMPORTED_MODULE_0__["default"])(context, null, options);
});
...
/* harmony import */ var renameitlib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! renameitlib */ "./node_modules/renameitlib/lib/index.js");
/* harmony import */ var renameitlib__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(renameitlib__WEBPACK_IMPORTED_MODULE_1__);
...
function showUpdatedMessage(count, data) {
  ...
  data.doc.showMessage("".concat(_Constants__WEBPACK_IMPORTED_MODULE_2__["exclamations"][Math.floor(Math.random() * _Constants__WEBPACK_IMPORTED_MODULE_2__["exclamations"].length)], " ").concat(count, " ").concat(layerStr, " renamed."));
}
...
var theUI = function theUI(context, data, options) {
  ...
  var getData = function getData() {
    var history = Object(_History__WEBPACK_IMPORTED_MODULE_3__["getHistory"])();
  ...
  contents.on("onClickRename", function (o) {
    var rename = new renameitlib__WEBPACK_IMPORTED_MODULE_1__["Rename"]({
      allowLayerStyle: false,
      allowTextStyle: false
    });
    var inputData = JSON.parse(o);
    data.selection.forEach(function (item) {
      var opts = Object(_utils__WEBPACK_IMPORTED_MODULE_5__["renameData"])(item, data.selectionCount, inputData.str, Number(inputData.startsFrom), data.pageName);
      var layer = data.selection[opts.currIdx].layer;
      layer.name = rename.layer(opts);
    });
    Object(_History__WEBPACK_IMPORTED_MODULE_3__["addRenameHistory"])(inputData.str);
    win.close();
  ...
  contents.on("onClickFindReplace", function (o) {
    ...
    selData.forEach(function (item) {
      var opts = Object(_utils__WEBPACK_IMPORTED_MODULE_5__["findReplaceData"])(item, inputData.findText, inputData.replaceText, Boolean(inputData.caseSensitive));
    ...
    Object(_History__WEBPACK_IMPORTED_MODULE_3__["addFindHistory"])(inputData.findText);
    Object(_History__WEBPACK_IMPORTED_MODULE_3__["addReplaceHistory"])(inputData.replaceText);
    win.close();
    showUpdatedMessage(totalRenamed, data);
  });
  contents.on("onClearHistory", function () {
    Object(_History__WEBPACK_IMPORTED_MODULE_3__["clearHistory"])();
    win.close();
  });
...
/*!**************************!*\
  !*** ./src/lib/utils.js ***!
  \**************************/
/*! exports provided: parseData, findReplaceDataParser, renameData, findReplaceData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
