...
var theUI = function theUI(context, data, options) {
  ...
  contents.on("onClickRename", function (o) {
    ...
    data.selection.forEach(function (item) {
      var opts = Object(_utils__WEBPACK_IMPORTED_MODULE_5__["renameData"])(item, data.selectionCount, inputData.str, inputData.startsFrom, data.pageName);
 ...
 * @Last Modified by: Rodrigo Soares
 * @Last Modified time: 2019-05-21 12:53:13
 */
// import sketch from "sketch" import Settings from "sketch/settings" //
// eslint-disable-line
