    ...
    value: function () {
      function render() {
        ...
        if (this.props.showClear != undefined) {
          clearBtn = _react2["default"].createElement("span", { id: "clearBtn", title: "Clear", className: this.props.showClear, onClick: this.props.onClear });
          clearBtnClass = "inputClearWrapper";
        }

        return _react2["default"].createElement("div", { className: "inputWrapper " + String(this.props.wrapperClass) }, _react2["default"].createElement("label", { htmlFor: this.props.id }, this.props.forName), _react2["default"].createElement("span", { className: clearBtnClass }, _react2["default"].createElement("input", { type: this.props.type, id: this.props.id, value: this.props.value, onChange: this.props.onChange, autoFocus: this.props.autoFocus, ref: function () {
            function ref(ip) {
              return _this2.myInp = ip;
            }

            return ref;
          }(), autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", spellCheck: "false", min: "0" }), clearBtn));
      }
...
var Preview = function (_React$Component) {
  ...
  _createClass(Preview, [{
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        this.setState({
          preview: nextProps.data.filter(function (val) {
            return val;
          }).join(', ')
        });
      }
    ...
    value: function () {
      function render() {
        return _react2['default'].createElement('div', { id: 'preview' }, 'Preview: ', _react2['default'].createElement('strong', null, this.state.preview));
      }
...
if (window.redirectTo != undefined) {
  App = function App() {
    return _react2['default'].createElement('div', null, _react2['default'].createElement(_routes2['default'], null), _react2['default'].createElement(_reactRouterDom.Redirect, { to: window.redirectTo }));
  };
} else {
  App = function App() {
...
_reactDom2['default'].render(_react2['default'].createElement(_reactRouterDom.HashRouter, null, _react2['default'].createElement(App, null)), document.getElementById('root'));
...
var _renameLayer = __webpack_require__(76);

var _renameLayer2 = _interopRequireDefault(_renameLayer);

var _findReplaceLayer = __webpack_require__(79);

var _findReplaceLayer2 = _interopRequireDefault(_findReplaceLayer);
...
exports['default'] = function () {
  return _react2['default'].createElement(_reactRouterDom.Switch, null, _react2['default'].createElement(_reactRouterDom.Route, { exact: true, path: '/find_replace', component: _findReplaceLayer2['default'] }), _react2['default'].createElement(_reactRouterDom.Route, { exact: true, path: '/rename', component: _renameLayer2['default'] }));
};
...
var _Rename = __webpack_require__(77);
...
var _KeywordButton = __webpack_require__(78);
...
var RenameLayer = function (_React$Component) {
  _inherits(RenameLayer, _React$Component);

  function RenameLayer(props) {
    _classCallCheck(this, RenameLayer);

    var _this = _possibleConstructorReturn(this, (RenameLayer.__proto__ || Object.getPrototypeOf(RenameLayer)).call(this, props));
  ...
  _createClass(RenameLayer, [{
    ...
    value: function () {
      function onChange(event) {
        ...
        this.setState({ valueAttr: event.target.value }, function () {
          return _this2.previewUpdate();
        });
    ...
    key: 'onChangeSequence',
    value: function () {
      function onChangeSequence(event) {
        var _this3 = this;
        ...
        this.setState({
          ...
          return _this3.previewUpdate();
        });
      }

      return onChangeSequence;
    }()
  }, {
    key: 'clearInput',
    value: function () {
    ...
    value: function () {
      function onButtonClicked(event) {
        ...
        event.preventDefault();
        var val = '' + String(this.state.valueAttr) + String(event.target.dataset.char);
        this.setState({
          valueAttr: val,
          inputFocus: true,
          showClear: 'show'
    ...
    value: function () {
      function onSubmit() {
        ...
        (0, _client2['default'])('onClickRename', JSON.stringify(d));
      }
    ...
    value: function () {
      function render() {
        ...
        var listItems = buttons.map(function (d) {
          return _react2['default'].createElement('li', { key: d.id, className: 'keywordBtn' }, _react2['default'].createElement(_KeywordButton2['default'], _extends({}, d, { click: _this7.onButtonClicked.bind(_this7) })));
        });

        return _react2['default'].createElement('div', { className: 'container rename' }, _react2['default'].createElement(_Input2['default'], nameInputAttr), _react2['default'].createElement(_Input2['default'], sequenceInputAttr), _react2['default'].createElement('div', { id: 'keywordsWrapper' }, _react2['default'].createElement('span', { className: 'title' }, 'Keywords'), _react2['default'].createElement('ul', { className: 'keywords' }, listItems), _react2['default'].createElement(_Preview2['default'], { data: this.state.previewData })), _react2['default'].createElement('div', { id: 'footer' }, _react2['default'].createElement('button', { id: 'cancelBtn', className: 'grey', onClick: this.onCancel }, 'Cancel'), _react2['default'].createElement('button', { id: 'submitBtn', onClick: this.onSubmit.bind(this) }, 'Rename')));
      }
...
function rename(options) {
  ...
  var aInterators = newLayerName.match(/%A/ig);
  ...
  // Replace plus
  newLayerName = newLayerName.replace(/(\\\+)|\+/, function (_, a) {
    return a || options.layerName;
  });
...
function currentLayer(newLayerName, layerName) {
  // UpperCase
  var name = newLayerName.replace(/%\*u%/ig, _changeCase2["default"].upperCase(layerName));

  // LowerCase
  name = name.replace(/%\*l%/ig, _changeCase2["default"].lowerCase(layerName));

  // Title Case
  name = name.replace(/%\*t%/ig, _changeCase2["default"].titleCase(layerName));

  // UpperCase First
  name = name.replace(/%\*uf%/ig, _changeCase2["default"].upperCaseFirst(layerName));

  // UpperCase First
  name = name.replace(/%\*c%/ig, _changeCase2["default"].camelCase(layerName));
...
var KeywordButton = function (_React$Component) {
  ...
  _createClass(KeywordButton, [{
    ...
    value: function () {
      function render() {
        return _react2["default"].createElement("a", { href: "#", id: this.props.id, "data-char": this.props.char, "data-tooltip": "Shortcut: " + String(this.props.char), onClick: this.props.click }, this.props.text);
      }
...
var _FindReplace = __webpack_require__(80);
...
var FindReplaceLayer = function (_React$Component) {
  _inherits(FindReplaceLayer, _React$Component);

  function FindReplaceLayer(props) {
    _classCallCheck(this, FindReplaceLayer);

    var _this = _possibleConstructorReturn(this, (FindReplaceLayer.__proto__ || Object.getPrototypeOf(FindReplaceLayer)).call(this, props));
  ...
  _createClass(FindReplaceLayer, [{
    ...
    value: function () {
      function onChange(event) {
        ...
        var isFind = event.target.id === "find";
        this.setState({
    ...
    key: 'onCaseSensitiveChange',
    value: function () {
      function onCaseSensitiveChange(event) {
        var _this4 = this;

        this.setState({ caseSensitive: event.target.checked }, function () {
          return _this4.previewUpdate();
        });
      }

      return onCaseSensitiveChange;
    }()
  }, {
    key: 'onCancel',
    value: function () {
    ...
    value: function () {
      function onSubmit() {
        ...
        (0, _client2['default'])('onClickFindReplace', JSON.stringify(d));
      }
    ...
    value: function () {
      function previewUpdate() {
        ...
        data.selection.forEach(function (item) {
          var options = {
            layerName: item.name,
            caseSensitive: _this5.state.caseSensitive,
            findText: _this5.state.findValue,
            replaceWith: _this5.state.replaceValue
          };
          renamed.push((0, _FindReplace2['default'])(options));
        });
        this.setState({ previewData: renamed });
      }
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement('div', { className: 'container findReplace' }, _react2['default'].createElement('span', { className: 'caseSensitiveWrapper' }, _react2['default'].createElement('input', { type: 'checkbox', id: 'caseSensitive', checked: this.state.caseSensitive, onChange: this.onCaseSensitiveChange.bind(this), onKeyUp: this.onKeyUp.bind(this) }), _react2['default'].createElement('label', { htmlFor: 'caseSensitive' }, ' case sensitive')), _react2['default'].createElement(_Input2['default'], findInputAttr), _react2['default'].createElement(_Input2['default'], replaceInputAttr), _react2['default'].createElement(_Preview2['default'], { data: this.state.previewData }), _react2['default'].createElement('div', { id: 'footer' }, _react2['default'].createElement('button', { id: 'cancelBtn', className: 'grey', onClick: this.onCancel }, 'Cancel'), _react2['default'].createElement('button', { id: 'submitBtn', onClick: this.onSubmit.bind(this) }, 'Rename')));
      }
  ...
  return FindReplaceLayer;
}(_react2['default'].Component);

exports['default'] = FindReplaceLayer;
...
function findReplace(options) {
  ...
  var found = options.layerName.match(reg);
...
var lowerCase = __webpack_require__(84)

var NON_WORD_REGEXP = __webpack_require__(89)
var CAMEL_CASE_REGEXP = __webpack_require__(90)
var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(91)
...
var upperCase = __webpack_require__(83)
...
exports.no = exports.noCase = __webpack_require__(82)
exports.dot = exports.dotCase = __webpack_require__(92)
exports.swap = exports.swapCase = __webpack_require__(93)
exports.path = exports.pathCase = __webpack_require__(94)
exports.upper = exports.upperCase = __webpack_require__(83)
exports.lower = exports.lowerCase = __webpack_require__(84)
exports.camel = exports.camelCase = __webpack_require__(86)
exports.snake = exports.snakeCase = __webpack_require__(87)
exports.title = exports.titleCase = __webpack_require__(95)
exports.param = exports.paramCase = __webpack_require__(96)
exports.header = exports.headerCase = __webpack_require__(97)
exports.pascal = exports.pascalCase = __webpack_require__(98)
exports.constant = exports.constantCase = __webpack_require__(99)
exports.sentence = exports.sentenceCase = __webpack_require__(100)
exports.isUpper = exports.isUpperCase = __webpack_require__(101)
exports.isLower = exports.isLowerCase = __webpack_require__(102)
exports.ucFirst = exports.upperCaseFirst = __webpack_require__(85)
exports.lcFirst = exports.lowerCaseFirst = __webpack_require__(103)
...
var camelCase = __webpack_require__(86)
var upperCaseFirst = __webpack_require__(85)
...
var upperCase = __webpack_require__(83)
var snakeCase = __webpack_require__(87)
